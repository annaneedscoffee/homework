...
import java8.streamapi.lab.streams_examples.lab.Seniority;
...
public class EmployeeUtils {
    ...
    //    Map<Seniority,Long> themap = employees.stream().collect(Collectors.groupingBy(Programmer::getSeniority),Collectors.counting());
       return null;
    }
